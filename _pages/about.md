...
<section class="home-section home-section--stacked reveal" id="research">
...
<section class="home-section home-section--stacked reveal" id="selected-publications">
  <div class="section-heading section-heading--row">
    <div>
      <p>03 / Selected Work</p>
      <h2>Publications</h2>
    </div>
    <a class="section-link" href="/publications/">View all publications <span aria-hidden="true">↗</span></a>
  </div>

  <div class="publication-grid">
    <article class="publication-card">
      <a class="publication-card__visual" href="/publication/2026-micon-bench" aria-label="Read MICON-Bench">
        <img src="/images/MICON-BENCH.PNG" alt="MICON-Bench overview">
      </a>
      <div class="publication-card__content">
        <p class="publication-card__venue"><span>CVPR 2026</span> Co-first Author</p>
        <h3><a href="/publication/2026-micon-bench">MICON-Bench: Benchmarking and Enhancing Multi-Image Context Image Generation</a></h3>
        <p>Mingrui Wu*, <strong>Hang Liu*</strong>, Jiayi Ji, Xiaoshuai Sun, Rongrong Ji</p>
        <div class="publication-card__links">
          <a href="https://arxiv.org/abs/2602.19497">Paper</a>
    ...
    <article class="publication-card">
      <a class="publication-card__visual" href="/publication/2025-rollingq-icml" aria-label="Read RollingQ">
        <img src="/images/rollingq.png" alt="RollingQ framework">
      </a>
      <div class="publication-card__content">
        <p class="publication-card__venue"><span>ICML 2025</span> Conference Paper</p>
        <h3><a href="/publication/2025-rollingq-icml">RollingQ: Reviving the Cooperation Dynamics in Multimodal Transformer</a></h3>
        <p>Haotian Ni, Yake Wei, <strong>Hang Liu</strong>, Gong Chen, Chong Peng, Hao Lin, Di Hu</p>
        <div class="publication-card__links">
          <a href="https://arxiv.org/abs/2506.11465">Paper</a>
          <a href="/publication/2025-rollingq-icml">Details</a>
        </div>
      </div>
    </article>
  </div>
